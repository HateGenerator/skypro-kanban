    ...
    <div className="cards__item">
      <div className="cards__card card">
        <div className="card__group">
          <div className={`card__theme ${topic === 'Web Design' ? '_orange' : topic === 'Research' ? '_green' : '_purple'}`}>
            <p className={topic === 'Web Design' ? '_orange' : topic === 'Research' ? '_green' : '_purple'}>
              {topic}
            </p>
          </div>
        ...
        <div className="card__content">
          <a href="#"><h3 className="card__title">{title}</h3></a>
